    ...
    <div class="nk-main">
        ...
        <div class="container">
            ...
            <div class="jumbotron" style="background-color: rgba(30, 30, 30, 0.6); text-align: center;">
               ...
               <br>
               <h3>🙂 You have successfully completed Round <?php require 'connection.php'; $sql = "select * from `imp` where 1;"; $result = mysqli_query($conn, $sql); $display = mysqli_fetch_array($result); echo $display['curr_round']; ?> for Arcane2.0 🙂</h3>
               <br>
               <h5>You can check the leaderboard here</h5>
               <br>
               <a href="leaderboard.php" class="nk-btn nk-btn-lg nk-btn-color-main-1 link-effect-4">
